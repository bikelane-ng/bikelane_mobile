            ...
            <View style={{ marginTop: 20, padding: 15 }}>
                <Card style={[{ padding: 10 }, styles.cardShadow]}>
                    {addressLoading ? <Spinner color={colors.default_text} /> : <View style={{ flexDirection: "row" }}>
                        ...
                        <View style={{ flex: 1, flexDirection: "column", position: "relative", right: 10, alignSelf: 'center' }}>
                            ...
                            <TouchableOpacity onPress={() => toggleSearchModal("dropOff")}>
                                <CardItem
                                    ...
                                    style={{ flexDirection: "column", alignItems: "flex-start", backgroundColor: '#EBEBEB', borderRadius: 20, width: '90%', margin: 10, marginLeft: 20, }}>
