...
class MapContainer extends React.Component {
  ...
  fitMarkers = () => {
    ...
    const region = [
      {
        longitude: parseFloat(pickUp.location.longitude),
        latitude: parseFloat(pickUp.location.latitude),
      },
      {
        longitude: parseFloat(dropOff.location.longitude),
        latitude: parseFloat(dropOff.location.latitude),
      },
    ];
  ...
  render() {
    const {pickUp, dropOff} =
      this.props.selectedAddress || this.props.rideDetails || {};
        ...
        <MapView
          ...
          {pickUp && dropOff ? (
            <MapViewDirections
              ...
              destination={
                dropOff.location.latitude + ',' + dropOff.location.longitude
              }
              apikey={API_KEY}
              strokeColor={'#000000'}
              strokeWidth={3}
