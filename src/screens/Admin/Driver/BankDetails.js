          ...
          <View style={{marginVertical: 10}}>
            ...
            <Item
              ...
              <Input
                ...
                onEndEditing={e =>
                  this.props.driverDetails({accountName: e.nativeEvent.text})
                }
                style={styles.input}
              />
            </Item>
          ...
          <View style={{marginVertical: 10}}>
            ...
            <Item
              ...
              <Input
                ...
                onEndEditing={e =>
                  this.props.driverDetails({accountNumber: e.nativeEvent.text})
                }
                style={styles.input}
              />
            </Item>
          ...
          <View style={{marginVertical: 10}}>
            ...
            <Item
              ...
              <Input
                ...
                onEndEditing={e =>
                  this.props.driverDetails({bank: e.nativeEvent.text})
                }
                style={styles.input}
              />
            </Item>
