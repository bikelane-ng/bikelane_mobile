    ...
    return (
      <SafeAreaView style={{flex: 1}}>
        <ScrollView contentContainerStyle={styles.container}>
          <Text
            style={{fontFamily: fonts.bold, fontSize: 20, paddingVertical: 30}}>
            Key in driver details
          </Text>
          ...
          <View style={{marginVertical: 10}}>
            ...
            <Item
              ...
              <Input
                ...
                onEndEditing={e =>
                  this.props.driverDetails({mobile: e.nativeEvent.text})
                }
                style={styles.input}
              />
            </Item>
          ...
          <View style={{marginVertical: 10}}>
            ...
            <Item
              ...
              <Input
                ...
                onEndEditing={e =>
                  this.props.driverDetails({firstName: e.nativeEvent.text})
                }
                style={styles.input}
              />
            </Item>
          ...
          <View style={{marginVertical: 10}}>
            ...
            <Item
              ...
              <Input
                ...
                onEndEditing={e =>
                  this.props.driverDetails({surname: e.nativeEvent.text})
                }
                style={styles.input}
              />
            </Item>
          ...
          <View style={{marginVertical: 10}}>
            ...
            <Item
              ...
              <Input
                ...
                onEndEditing={e =>
                  this.props.driverDetails({email: e.nativeEvent.text})
                }
                autoCapitalize={'none'}
                style={styles.input}
              />
          ...
          <View style={{marginVertical: 10}}>
            ...
            <Item
              ...
              error={
                (this.houseAddress === undefined || this.houseAddress === '') &&
                this.state.validationErr
              }
              rounded>
              <Input
                ...
                onEndEditing={e =>
                  this.props.driverDetails({houseAddress: e.nativeEvent.text})
                }
                style={styles.input}
              />
            </Item>
          ...
          <View style={{marginVertical: 10}}>
            ...
            <Item
              ...
              <Input
                ...
                onEndEditing={e =>
                  this.props.driverDetails({password: e.nativeEvent.text})
                }
