...
class OTP extends React.Component {
    ...
    UNSAFE_componentWillReceiveProps(prevProps) {
        if (prevProps.validate && this.props.validate !== prevProps.validate) {
            ...
            this.props.navigation.navigate('VerifyDriverOTP');
        }
    }
                        ...
                        <Item>
                            ...
                            <View style={{ flexDirection: 'row', }}>
                                <View style={{ justifyContent: 'center' }}>
                                    <Text style={{ fontSize: 16, fontFamily: fonts.medium, }}>+234</Text>
                                </View>
                                <View style={{ height: 30, width: 0.4, backgroundColor: colors.btnColor, marginHorizontal: 10 }}></View>
                            </View>
                            <Input
