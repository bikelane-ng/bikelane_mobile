          ...
          <View style={{marginVertical: 10}}>
            ...
            <Item
              ...
              <Input
                ...
                onEndEditing={e =>
                  this.props.driverDetails({licensePlate: e.nativeEvent.text})
                }
                style={styles.input}
              />
            </Item>
          ...
          <View style={{marginVertical: 10}}>
            ...
            <Item
              ...
              <Input
                ...
                onEndEditing={e =>
                  this.props.driverDetails({model: e.nativeEvent.text})
                }
                style={styles.input}
              />
            </Item>
          ...
          <View style={{marginVertical: 10}}>
            ...
            <Item
              ...
              <Input
                ...
                onEndEditing={e =>
                  this.props.driverDetails({brand: e.nativeEvent.text})
                }
                style={styles.input}
              />
            </Item>
