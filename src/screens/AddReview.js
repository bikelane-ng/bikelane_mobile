...
class AddReview extends Component {
    ...
    UNSAFE_componentWillReceiveProps(prevProps) {
        if (prevProps.home.refreshed && prevProps.home.refreshed != this.props.home.refreshed) {
                    ...
                    <View style={styles.container}>
                        <View style={{ alignItems: 'center' }}>
                            <Thumbnail
                                ...
                                source={ride.avatar ? { uri: ride.avatar } : require('../imgs/avatar.png')}
                            />
                            <View style={{ alignItems: 'center', marginTop: 10, }}>
                                <Text style={{ fontFamily: fonts.medium, }}>{`${ride.firstName} ${ride.surname}`}</Text>
                                <Text style={{ color: colors.gray, }}>{ride.driverInfo && ride.driverInfo.vehicleInfo.licensePlate}</Text>
                            </View>
