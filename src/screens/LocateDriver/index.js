...
class LocateDriver extends Component {
    ...
    componentDidMount() {
        ...
        var nearestDriver = this.props.home.nearbyDrivers.reduce((prev, curr) => curr.distance < prev.distance ? curr : prev);
                        ...
                        <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
                            ...
                            <View style={{ flexDirection: "column", marginRight: 250, paddingLeft: 20, width: "100%" }}>
                                <View>
                                    ...
                                    <Text style={{ color: "white", fontFamily: 'NoirPro-Medium' }}>{this.props.home.inputData.pickUp.name}</Text>
                                </View>
                                <View style={{ marginTop: 5 }}>
                                    <Text style={{ color: "#bbb", fontSize: 10 }}>Destination</Text>
                                    <Text style={{ color: "white", fontFamily: 'NoirPro-Medium' }}>{this.props.home.inputData.dropOff.name}</Text>
                                </View>
                            </View>
                            {/* <View>
                                <Text style={{ color: "#bbb", fontSize: 10 }}>Pick Up</Text>
