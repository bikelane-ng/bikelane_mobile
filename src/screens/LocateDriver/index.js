...
class LocateDriver extends Component {
  ...
  componentDidMount() {
    ...
    var nearestDriver = this.props.home.nearbyDrivers.reduce((prev, curr) =>
      curr.distance < prev.distance ? curr : prev,
    );
    socket.emit('locateDriver', this.props.home.nearbyDrivers);
    setTimeout(() => {
        ...
        <View>
          <View style={{padding: 30}}>
            <Text
              ...
              Locating nearby drivers, please wait...
            </Text>
          </View>
              ...
              <View style={{marginTop: 8}}>
                ...
                <View>
                  <Icon
                    type="Ionicons"
                    name="ios-pin"
                    style={{fontSize: 22, color: '#FF4531', marginLeft: -1.5}}
                  />
                </View>
              </View>
              <View
                ...
                <View>
                  ...
                  <Text style={{color: 'white', fontFamily: 'NoirPro-Medium'}}>
                    {this.props.home.inputData.pickUp.name}
                  </Text>
                </View>
                <View style={{marginTop: 5}}>
                  <Text style={{color: '#bbb', fontSize: 10}}>Destination</Text>
                  <Text style={{color: 'white', fontFamily: 'NoirPro-Medium'}}>
                    {this.props.home.inputData.dropOff.name}
                  </Text>
                </View>
              </View>
              {/* <View>
