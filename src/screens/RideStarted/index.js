...
const PaymentMethod = ({ rideDetails, }) => {
    ...
    return (
        <>
            <View style={{ justifyContent: 'center', paddingHorizontal: 15, paddingTop: 15, marginTop: 2, marginBottom: 15, }}>
                <Text style={{ fontSize: 14, fontFamily: fonts.medium, }}>Your trip has started</Text>
            </View>
