                    ...
                    <View style={{ marginTop: 50 }}>
                        <View style={{ alignItems: "center" }}>
                            ...
                            <View style={{ marginTop: 10 }}>
                                <Text style={{ fontFamily: fonts.default, fontSize: 16 }}>John Doe</Text>
                            </View>
                        </View>
                        ...
                        <View style={{ marginTop: 20 }}>
                            <View style={{ borderBottomColor: "#ccc", borderBottomWidth: 1, flexDirection: "row", paddingBottom: 18 }} regular>
                                <Icon style={{ color: colors.default }} type="Ionicons" name="ios-mail" />
                            ...
                            <View style={{ marginTop: 20, borderBottomColor: "#ccc", borderBottomWidth: 1, flexDirection: "row", paddingBottom: 18 }} regular>
                                <Icon style={{ color: colors.default }} type="Ionicons" name="ios-call" />
                        ...
                        <View style={{ flex: 1, marginTop: 20 }}>
                            <View style={{ flexDirection: "row", flex: 1 }}>
                                <View>
                                    <Icon style={{ color: colors.default }} type="Ionicons" name="ios-pin" />
                                </View>
                        ...
                        <View style={{ marginTop: 30 }}>
                            <Button
                                ...
                                success
                                // onPress={() => }
                                style={{ height: 50, width: "100%", borderColor: colors.default }} block>
                                <Text style={{ color: "white", color: colors.default }}>CHANGE PASSWORD</Text>
                            </Button>
                        </View>
                        ...
                        <View style={{ marginTop: 20 }}>
                            <Button
                                // onPress={() => }
                                style={{ backgroundColor: colors.default, height: 50, width: "100%" }} block>
