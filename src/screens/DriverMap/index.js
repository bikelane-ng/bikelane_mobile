...
import {Icon, Spinner, Card} from 'native-base';
...
class DriverMap extends React.Component {
  constructor(props) {
    ...
    this.props.socket.on('Payment.push', data => {
      ...
      this.props.navigation.dispatch(
        NavigationService.resetAction('TripDetails'),
      );
    });
  }
  ...
  UNSAFE_componentWillReceiveProps(prevProps) {
    if (
      prevProps.home.location &&
      prevProps.home.location != this.props.home.location
    ) {
      this.setState({
        region: {
    ...
    if (
      prevProps.home.selectedAddress &&
      prevProps.home.selectedAddress != this.props.home.selectedAddress
    ) {
    ...
    if (
      prevProps.driver.status &&
      prevProps.driver.status != this.props.driver.status
    ) {
      this.setState({
        updateStatus: false,
      });
  ...
  render() {
    ...
    return (
      <View style={{flex: 1}}>
        ...
        {this.state.rideDetails && !this.props.home.hideAlert && (
          <RideDetails
            ...
            <View style={{marginTop: 20, padding: 15}}>
              <Card style={[{paddingBottom: 10}, styles.cardShadow]}>
                {this.props.home.processing ? (
                  ...
                  <>
                    {this.props.home.arrive && (
                      <ArrivedLocation
                        rideDetails={this.props.home.rideDetails}
                        arrived={() => this.changeStatus(rideStatus.ARRIVED)}
                        isRideStatusUpdated={
                          this.props.home.isRideStatusUpdated
                        }
                ...
                <View
                  ...
                  <View
                    ...
                    <View
                      ...
                      <Acceptance />
                      <Text
                        style={{paddingVertical: 5, fontFamily: fonts.medium}}>
                        95.0%
                      </Text>
