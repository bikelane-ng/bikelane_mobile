    ...
    return (
      <View style={{flex: 1, backgroundColor: '#FAFAFA'}}>
                    ...
                    <Item
                      ...
                      <Input
                        ...
                        value={
                          inputData &&
                          inputData['pickUp'] &&
                          inputData['pickUp'].length > truncateLength
                            ? `${inputData['pickUp'].substring(
                                0,
                                truncateLength,
                              )}...`
                            : inputData['pickUp']
                      ...
                      {inputData &&
                        inputData['pickUp'] &&
                        inputData['pickUp'].length > 0 &&
                        !searching && (
                          <TouchableOpacity
                            onPress={() => this.props.clearInputData('pickUp')}>
                            <Icon
                              style={{
                                color: colors.gray,
                                fontSize: 30,
                  ...
                  <View style={{marginTop: 10}}>
                    <Item
                      ...
                      <Input
                        ...
                        autoFocus={false}
                        value={
                          inputData && inputData['dropOff'] && inputData.dropOff
                        }
                      />
                      {inputData &&
                        inputData['dropOff'] &&
                        inputData['dropOff'].length > 0 &&
                        !searching && (
                          <TouchableOpacity
                            onPress={() =>
                              this.props.clearInputData('dropOff')
                            }>
                            <Icon
                              style={{
                                color: colors.gray,
        ...
        <View style={{flex: 1}}>
                ...
                renderRow={item => (
                  <TouchableOpacity
                    ...
                    <View
                      ...
                      <Icon
                        style={{fontSize: 20, color: colors.default}}
                        name="ios-pin"
                      />
                      <View
                        style={{
                    ...
                    <View>
                      <Icon
                        style={{color: colors.default, fontSize: 20}}
                        name="ios-heart"
                      />
                    </View>
                  </TouchableOpacity>
          ...
          {!inputData['pickUp'] && !inputData['dropOff'] ? (
            <PlacesComponent />
          ) : null}
